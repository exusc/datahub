# Generated by Django 5.0.3 on 2024-12-03 07:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ctime', models.DateTimeField(blank=True, null=True, verbose_name='Create Time')),
                ('cuser', models.CharField(blank=True, max_length=8, null=True, verbose_name='Create User')),
                ('utime', models.DateTimeField(blank=True, null=True, verbose_name='Update Time')),
                ('uuser', models.CharField(blank=True, max_length=8, null=True, verbose_name='Update User')),
                ('key', models.CharField(max_length=20, unique=True, verbose_name='key')),
                ('bu1_type', models.CharField(blank=True, max_length=80, null=True, verbose_name='Business_Unit_Type_1')),
                ('bu2_type', models.CharField(blank=True, max_length=80, null=True, verbose_name='Business_Unit_Type_2')),
                ('bu3_type', models.CharField(blank=True, max_length=80, null=True, verbose_name='Business_Unit_Type_3')),
                ('bu4_type', models.CharField(blank=True, max_length=80, null=True, verbose_name='Business_Unit_Type_4')),
                ('bu5_type', models.CharField(blank=True, max_length=80, null=True, verbose_name='Business_Unit_Type_5')),
                ('bu1_field', models.CharField(blank=True, max_length=80, null=True, verbose_name='fieldname_1')),
                ('bu2_field', models.CharField(blank=True, max_length=80, null=True, verbose_name='fieldname_2')),
                ('bu3_field', models.CharField(blank=True, max_length=80, null=True, verbose_name='fieldname_3')),
                ('bu4_field', models.CharField(blank=True, max_length=80, null=True, verbose_name='fieldname_4')),
                ('bu5_field', models.CharField(blank=True, max_length=80, null=True, verbose_name='fieldname_5')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('execute_scripts', models.BooleanField(default=False, help_text='Only if activated scripts will be executed', verbose_name='execute_scripts')),
            ],
            options={
                'verbose_name': 'Container',
                'verbose_name_plural': 'Containers',
                'ordering': ['key'],
                'permissions': [('upload_templates', 'Is allowed to upload report templates'), ('download_templates', 'Is allowed to download report templates'), ('db_read_access', 'Is allowed connect to db and read data')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'ContainerSystem',
                'verbose_name_plural': 'ContainerSystems',
            },
        ),
        migrations.CreateModel(
            name='Area',
        ...
        migrations.AddField(
            ...
            name='containersystem',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='organization.containersystem'),
        ),
        migrations.CreateModel(
            name='Owner',
            fields=[
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Areascope',
                'verbose_name_plural': 'Areascopes',
            },
        ),
        migrations.AddField(
            model_name='area',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('areascopes', models.ManyToManyField(blank=True, to='organization.areascope')),
                ('use_areascope', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='organization.areascope')),
                ('owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='organization.owner')),
            ],
            options={
                'verbose_name': 'User',
